    ...
    return (
        <aside className="d-flex justify-content-center align-items-center">
            <div className="container-fluid">
              ...
              {asaide.map((elemet)=>{
return <div className=" d-flex justify-content-center align-items-center p-2 cardP " key={elemet.id} ><img className=" w-100   p-2" src={elemet.src} alt="" />
<div><a className="" href="#">{elemet.text}</a></div> 
</div>   
              })}
                </div>
